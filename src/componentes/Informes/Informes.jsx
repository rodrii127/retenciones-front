                        ...
                        <div className="busqueda_factura">
                            ...
                            <div className="contenido">
                                <div className="criterio_busqueda">
                                    ...
                                    <InputBuscador style={{ marginLeft: "5px" }} nombre={"Proveedor:"} lista={providerList} />
                                    <div className="boton_buscador">
                                        <div className="titulo_buscador" onClick={findRetentions}> Buscar </div>
                                ...
                                <div className="caja_tabla">
                                    {
                                        flagBusqueda ?
                                            ...
                                            :
                                            <TablaRetenciones listaBuscada={listaBuscada} />
                                    }
                                </div>
