...
export const TablaConCheck = (props) => {
    ...
    const selectCheckboxItem = (event, elemento) => {
        ...
        if (event.target.checked) {
            props.setSelectedCheckboxItems([
                ...newSelectedCheckboxItems,
                elemento,
            ]);
        } else {
            newSelectedCheckboxItems = props.selectedCheckboxItems.filter(
    ...
    return (
        <div className="caja_tabla_resultado">
            <div className="encabezado_tabla">
                ...
                <div className="columna" style={{ width: "40%" }}>
                    {" "}
                    Proveedor{" "}
                </div>
            ...
            <div className="filas_tabla">
                {props.listaBuscada.map((elemento, index) => {
                    return (
                        <div key={index} className="fila_tabla">
                            <div
                                className="columna check"
                                style={{ width: "10%" }}
                            >
                                <input
                                    type="checkbox"
                                    onClick={(event) =>
                                        selectCheckboxItem(event, elemento)
                                    }
                                />
                            </div>
                            <div className="columna" style={{ width: "10%" }}>
                            ...
                            <div className="columna" style={{ width: "40%" }}>
                                {elemento.provider.companyName}
                            </div>
                            <div className="columna" style={{ width: "20%" }}>
                                {elemento.pointSale + "-" + elemento.number}
                            </div>
                            <div className="columna" style={{ width: "20%" }}>
                                {getTotal(elemento)}
                            </div>
